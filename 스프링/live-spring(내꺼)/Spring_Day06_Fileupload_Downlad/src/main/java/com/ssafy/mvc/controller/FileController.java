...
public class FileController {
		//스프링에서 파일이나 클래스 등등 ㄹ ㅣ소스를 로드할때는 ResourceLoader 인터페이스를 이용해서 가져온다.
		...
		public String singleFileUpload(@RequestParam("file") MultipartFile file, Model model) throws IllegalStateException, IOException {
			...
			if(file != null && file.getSize() > 0) {
				...
				Resource resource = resourceLoader.getResource("classpath:/static/img"); // << 대문자 S 소문자로 바꾸시오
				System.out.println("윤준ㅋ");
